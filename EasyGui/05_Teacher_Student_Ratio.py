...
while yes_no == "Yes":
    ...
    yes_no = easygui.buttonbox("Do you want to perform another calculation? ", "Repeat or end",
                               choices=["Yes", "No"])
